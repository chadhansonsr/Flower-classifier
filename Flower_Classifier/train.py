...
parser.add_argument("--data_dir", type=str, default=r"/Users/t9349ch/Desktop/SWX/Udacity/Python Projects/Flower classifier/flowers", help="path to data directory")
